#!/usr/bin/env python3
"""
Evaluate LSTM-based policy ID prediction from .npy motion files.
Uses the same approach as eval_policy_id_prediction_vqvae.py but with LSTM model.
"""
...
class LSTMPolicyIDEvaluator:
    def __init__(
        ...
        frame_size = self._ckpt.get('frame_size', 50)
        ...
        self.model.eval()
        print(f"[Eval][LSTM] Loaded model. num_policies={num_policies}, frame_size={frame_size}")
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="./evaluation_lstm_policy_id")
...
'''
# Example usage for LSTM policy ID predictor evaluation:
